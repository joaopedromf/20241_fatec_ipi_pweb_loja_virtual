...
export class PesquisaComponent {
  ...
  constructor(){
    try{
      ...
      this.listaFiltrada = this.lista.filter((produto) => produto.nome.toUpperCase().includes(this.pesquisa.toUpperCase()));
    }
    catch(e){}
  }
